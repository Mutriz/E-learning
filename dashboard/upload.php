...
<div id="wrapper">
	...
	<div class="form-group">
		...
		<input type="text" name="title" class="form-control" placeholder="Eg: Adanced artificial intelligence pdf,PHP tutorial" ">
	</div>
	...
	<div class="form-group">
		...
		<textarea  class="form-control" placeholder="This field cannot be empty" name="description" id="" cols="12" rows="6">
		</textarea>
	</div>
