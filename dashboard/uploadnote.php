...
$gump->validation_rules(array(//Create a custom validation rule named
...
if (isset($_SESSION['id'])) {
	...
	//alidating a file for a upload

    $file = $_FILES['file']['name'];// contain the temporary file name of the file on the server. 
    $ext = pathinfo($file, PATHINFO_EXTENSION);//will yield incorrect results if the path contains a query string with dots in the parameter names
