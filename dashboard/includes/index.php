     ...
     <div class="slider_container">
		<div class="flexslider">
	      <ul class="slides">
			...
			<li>
	    		<a href="#"><img src="images/slider/one.jpg" alt="" title=""/></a>
	    		<div class="flex-caption">
                     <div class="caption_title_line"><h2>Easy to use</h2><p>Create your account and experience the E-learning method</p></div>
                </div>
	    	</li>
	    	...
	    	<li>
	    		...
	    		<div class="flex-caption">
                     <div class="caption_title_line"><h2>Upload Various studying materials</h2><p>User can upload various types of files like PDF, PPT, DOC etc..</p></div>
                </div>
	    	</li>
	    	<li>
